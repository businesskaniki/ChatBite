...
function Navbar() {
  return (
    <nav className="flex items-center justify-between bg-blue-300 py-2 px-4 fixed bottom-0 left-0 right-0 lg:relative lg:bg-blue-700 lg:py-4 lg:px-8 shadow-md">
      <div className="hidden lg:flex items-center justify-between">
        <div className="flex-shrink-0 flex items-center justify-between">
          <img className="block lg:hidden h-8 w-auto" src="https://designpress.com/wp-content/uploads/2013/02/popular-logos/sony-ericsson-logo.jpg" alt="Company Logo" />
          <img className="hidden lg:block h-8 w-auto" src="https://designpress.com/wp-content/uploads/2013/02/popular-logos/sony-ericsson-logo.jpg" alt="Company Logo" />
        </div>
        <div className="flex">
